-- Updated database schema for Penny-Debt CRM system with OTP tables

-- Table for storing OTPs temporarily
...
-- Table for storing verified emails
...
('company_email', 'care@pennyanddebt.in', 'Company contact email'),
...
-- Create uploads directory structure (run this manually)
-- mkdir uploads
